...
console.log("Process Architecturd:", process.arch);
...
testVar ="var changed";
testLet = "let changed"
// TEST_CONST = "const changed"; // 오류 const는 재할당 불가

// ES6 지원 환경에서는 let, const 사용
// 우선 const를 먼저 고려 -> 값이 바뀌는 것이 자연스러울 경우  let으로 교체
// 자바스크립트는 데이터 타이빙 교려되지않음
// 데이터가 할당되엇을 때, 그 타입이 결정
