...
console.log("=================Casting");
// 자바스크립트는 변수 선언시 데이터 타입으 지정하지 않고,
// 중간에 데이터 타입이 변경될 수 있으므로 데이터 형 변환이 필요한 경우가 많다.

// parseInt, parseFloat : Number 타입으로 변환하는 함수
console.log(parseInt("011"), typeof parseInt("011"));
console.log("11" + "12"); // 1122 로 출력
console.log(parseInt("11") + parseInt("12")); //23으로 출력

console.log(parseInt("011", 2)); //2진수
console.log(parseInt("0xff0000", 16)); //16진수
console.log(parseInt("123.456")); // 정수 형태만 변환
console.log(parseFloat("123.456")); // 실수전체
...
// Infitity와 수치형 데이터의 산술 연산 -> Infinity
let result = 1 / 0 + 2024;
